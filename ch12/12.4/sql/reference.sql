CREATE TABLE vehicles(
  ...
  year SMALLINT,
  FOREIGN KEY(vin) REFERENCES events("vehicle.vin"));
INSERT INTO vehicles ("1HGCM82633A004352", "Ford", "Transit", 2005),
...
CREATE TABLE employees(
  ...
  dob DATE NOT NULL,
  FOREIGN KEY(id) REFERENCES events("employee.id"));
...
CREATE TABLE packages(
  id CHAR(36) NOT NULL,
  weight INT NOT NULL,
  FOREIGN KEY(id) REFERENCES events("package.id"));
